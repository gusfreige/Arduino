...
DefaultDirName={pf}\Arduino\Arduino ERW 1.0.1i
...
[Icons]
Name: "{group}\Arduino ERW 1.0.1i"; Filename: {app}\arduino.exe; 
Name: "{group}\Configure Board Drivers"; Filename: {app}\drivers\DriverHelper.exe; Flags: excludefromshowinnewinstall; 
Name: "{userdesktop}\Arduino ERW 1.0.1i"; Filename: {app}\arduino.exe; Tasks: desktopicon; 
