...
DefaultDirName={pf}\Arduino\Arduino ERW 1.0.2
...
[Files]
Source: "files\arduino-1.0.2\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{group}\Arduino ERW 1.0.2"; Filename: {app}\arduino.exe; 
Name: "{group}\Configure Board Drivers"; Filename: {app}\drivers\DriverHelper.exe; Flags: excludefromshowinnewinstall; 
Name: "{userdesktop}\Arduino ERW 1.0.2"; Filename: {app}\arduino.exe; Tasks: desktopicon; 
